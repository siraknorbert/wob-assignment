...
class ListingStatusApiClientTest {
    ...
    @Test
    void testGetListingStatusList200Ok() throws DataSyncRestException {
        // given
        List<ListingStatusDto> expectedResponse = new ArrayList<>();
        ResponseEntity<List<ListingStatusDto>> responseEntity = new ResponseEntity<>(expectedResponse, HttpStatus.OK);
        ...
        listingStatusApiClient.getListingStatusList();
